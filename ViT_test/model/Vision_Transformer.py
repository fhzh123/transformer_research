...
class Vision_Transformer(nn.Module):
    def __init__(self, n_class, d_model=512, d_embedding=256, n_head=8, dim_feedforward=2048,
        ...
        self.trg_output_linear2 = nn.Linear(d_embedding, n_class)

    def forward(self, src_img: Tensor) -> Tensor:
        # Image embedding
        emb_out = self.patch_embedding(src_img)
