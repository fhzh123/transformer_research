...
if __name__=='__main__':
    ...
    # Model setting
    parser.add_argument('--d_model', default=256, type=int, help='Model dimension; Default is 768')
    parser.add_argument('--d_embedding', default=128, type=int, help='Embedding dimension; Default is 256')
    parser.add_argument('--n_head', default=8, type=int, help='Mutlihead count; Default is 12')
    parser.add_argument('--dim_feedforward', default=512, type=int, help='Feedforward layer dimension; Default is 2048')
    parser.add_argument('--n_layers', default=6, type=int, help='Layer count; Default is 8')
    # Training setting
